  ...
  const courseDetails = [
    ...
    },
    {
      ...
      description: [
        ...
        "Початкові навички на власному закритому автодромі",
    ...
    },
    {
      ...
      description: [
        ...
        "Особливості керування великогабаритним транспортним засобам",
        "Маневрування та проходження складних ділянок маршруту",
        "Правила безпечного перевезення вантажів",
        "Практичні заняття на автомобілі категорії CE",
